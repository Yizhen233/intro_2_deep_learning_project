...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams, input_size=28 * 28, latent_dim=20):
        ...
        self.encoder = nn.Sequential(
            #nn.Linear(input_size, self.latent_dim)
...
class Autoencoder(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        pass
        vect=self.encoder(x)
        reconstruction=self.decoder(vect)
    ...
    def configure_optimizers(self):
        ...
        optim = torch.optim.Adam(params,self.hparams["learning_rate"])
...
class Classifier(pl.LightningModule):
    ...
    def __init__(self, hparams, encoder, train_set=None, val_set=None, test_set=None):
        ...
        pass
        self.model=nn.Linear(self.encoder.latent_dim,self.hparams["num_classes"])
        #self.model=nn.Identity(self.encoder.latent_dim)
