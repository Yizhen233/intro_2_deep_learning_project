...
class RescaleTransform:
    ...
    def __call__(self, images):
        ...
        pass
        in_ranges=self._data_max-self._data_min
        out_ranges=self.max-self.min
        m=out_ranges/in_ranges
        images=m*images+self.min
        #for i in np.nditer(images, op_flags = ['readwrite']):
        #    i[...]=m*i+self.min
